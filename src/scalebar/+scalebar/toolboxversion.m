function versionStr = toolboxversion()
    ...
    %
    %   Example:
    %       version = scalebar.toolboxversion()
    %
    %   See also scalebar.toolboxdir
    ...
    if isempty(matchedStr)
        error('SCALEBAR:Version:VersionNotFound', ...
            'No version was detected for this scalebar installation.')
    end
